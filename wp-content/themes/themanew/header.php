...
<head id="<?php echo of_get_option('meta_headid'); ?>" data-template-set="themanew-wordpress-theme">
	...
	<script src="<?php echo get_template_directory_uri(); ?>/dev/bower_components/imagesloaded/imagesloaded.pkgd.min.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/dev/bower_components/skrollr/dist/skrollr.min.js"></script>
