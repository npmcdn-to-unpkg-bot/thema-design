 ...
 *
 * If you are making your theme translatable, you should replace 'themanew'
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Header Meta', 'themanew'),
		'type' => 'heading');

// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'themanew'),
		'desc' => __("", 'themanew'),
		'id' => 'meta_headid',
		'std' => 'themanew',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'themanew'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'themanew'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'themanew'),
		'desc' => __('Populates meta author tag.', 'themanew'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'themanew'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'themanew'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'themanew'),
		'desc' => __('', 'themanew'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'themanew'),
		'desc' => __('', 'themanew'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'themanew'),
		'desc' => __('Application Name', 'themanew'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __('Tile Color', 'themanew'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __('Tile Image', 'themanew'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'themanew'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'themanew'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __('twitter:site (@username of website)', 'themanew'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'themanew'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __('twitter:description (maximum 200 characters)', 'themanew'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __('twitter:url (url for the content)', 'themanew'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'themanew'),
		'desc' => __('og:title', 'themanew'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __('og:description', 'themanew'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __('og:url', 'themanew'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'themanew'),
		'desc' => __('og:image', 'themanew'),
